...
;switch string lower cases to upper case
...
;instructions
;backup affected registers
ST R1, backup_3_r1_3600
ST R2, backup_3_r2_3600
ST R3, backup_3_r3_3600
ST R7, backup_3_r7_3600

LD R3, char_offset

;iterate through the string and change lower cases to upper case
LDR R2, R1, #0
...
ADD R1, R1, #1
LDR R2, R1, #0
BRnp ITERATE_THROUGH_STRING

;restore backup register
LD R1, backup_3_r1_3600
LD R2, backup_3_r2_3600
LD R3, backup_3_r3_3600
LD R7, backup_3_r7_3600

RET
;data
;and lower case with 0101 1111 = x5F to change to upper case
char_offset .FILL x5F
backup_3_r1_3600 .blkw #1
backup_3_r2_3600 .blkw #1
backup_3_r3_3600 .blkw #1
backup_3_r7_3600 .blkw #1
.END